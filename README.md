...
```
Total Patients: 1314
├── Obstructive Cases: 1100 (83.6%)
└── Non-obstructive Cases: 214 (16.4%)
```
...
```
┌─────────────────────────────────────────────────────────────────┐
│                MEDICAL ML DIAGNOSTIC SYSTEM                     │
├─────────────────────────────────────────────────────────────────┤
│  ┌──────────────┐  ┌────────────────┐  ┌─────────────────┐    │
│  │  Raw Clinical│  │  Data Pre-     │  │  Feature        │    │
│  │  Spirometry  │→ │  processing    │→ │  Engineering    │    │
│  │    Data      │  │  & Cleaning    │  │  & Selection    │    │
│  └──────────────┘  └────────────────┘  └─────────────────┘    │
│         │                         │                │           │
│  ┌──────▼──────┐          ┌───────▼───────────────▼──────┐    │
│  │  Exploratory │          │   Machine Learning Suite    │    │
│  │  Data        │          │  ┌──────────────────────┐  │    │
│  │  Analysis    │          │  │ • Logistic Regression │  │    │
│  │  (EDA)       │◄─────────┤  │ • Naive Bayes        │  │    │
│  └──────────────┘  Insights│  │ • K-Nearest Neighbors│  │    │
│         │                  │  │ • Support Vector Mach.│  │    │
│  ┌──────▼──────┐          │  │ • Decision Tree       │  │    │
│  │  Medical     │          │  │ • Artificial Neural N.│  │    │
│  │  Visualization│         │  │ • Deep Neural Network │  │    │
│  │  & Reports   │          │  └──────────────────────┘  │    │
│  └──────────────┘          └────────────────────────────┘    │
│         │                                  │                  │
│  ┌──────▼──────┐                  ┌───────▼──────────────┐   │
...
│                                    │  │ • Precision  │   │   │
│  ┌─────────────────────────────────┤  │ • Recall     │   │   │
│  │  Deployment & Clinical          │  │ • F1-Score  │   │   │
│  │  Decision Support System        │  │ • ROC-AUC   │   │   │
│  └─────────────────────────────────┘  └──────────────┘   │   │
└───────────────────────────────────────────────────────────┘
```
...
- **Architecture**: 100 → 70 → 40 → 24 → 8 → 2 neurons
